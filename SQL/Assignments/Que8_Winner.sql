...
(1970,'Literature','Aleksandr Solzhenits','Russia','Linguist'),
(1970,'Economics','Paul Samuelson','USA','Scientist');

select * from Winner

select years, Subject, Winners from winner where years = 1970 order by 
years, Subject , Winners
