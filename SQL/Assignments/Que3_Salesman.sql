*Que 3 - Write a query to display the columns in a specific order like order date, 
...
select ordDate,salesmanId,ordNo,purcAmt, customerId from salesman1 
order by 
ordDate,salesmanId,ordNo,purcAmt, customerId;
